...
# Lista de colunas específicas diretamente no código Python
lista_colunas_especificas = [
...
# Criar um dataframe com as colunas especificadas
df_quali = df[lista_colunas_especificas]
